...
sealed class Screen(val route: String, val title: String, val icon: Int,val iconsFocused :Int) {
    ...
    object RemainderScreen : Screen("remainder_screen", title = "Reminder", icon = R.drawable.ic_bottom_location_add, iconsFocused = R.drawable.ic_bottom_location_add_focused)
}